        ...
        <div className="w-full h-full border border-black rounded-xl blur-none">
          ...
          <nav className="flex items-center justify-between px-12 py-6">
            <span className='flex items-center text-3xl tracking-tighter text-white'><svg className='w-5 mr-6' viewBox="0 0 23 17" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              ape id</span>
            {!currentAccount ?
              <button onClick={connectWallet} className="px-5 py-2 text-base font-medium text-white bg-black shadow rounded-3xl hover:bg-gray-800 ">
                Get Started
              </button> : <div className='px-5 py-2 text-base font-medium text-white bg-black shadow rounded-3xl hover:bg-gray-800'> {shortenAddress(currentAccount)}</div>}
          </nav>
